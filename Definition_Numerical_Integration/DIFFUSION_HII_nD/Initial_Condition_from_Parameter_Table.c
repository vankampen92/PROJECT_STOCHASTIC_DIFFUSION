...
void Initial_Condition_One_Single_Cell_into_Parameter_Table (Parameter_Table * Table,
               ...
               /* Value_0 is usually Table->TOTAL_No_of_FREE_CONSUMERS_TIME_0,
						      Value_1 is uusally Table->TOTAL_No_of_HANDLING_CONSUMERS_TIME_0, 
               ...
               */
{
  ...
  printf ("TOTAL_No_of_CONSUMERS: %d\n", Table->TOTAL_No_of_CONSUMERS); 
  printf ("TOTAL_No_of_HANDLING_CONSUMERS: %g\n", x); 
  x = Table->TOTAL_No_of_CONSUMERS - x;  
  printf ("TOTAL_No_of_FREE_CONSUMERS: %g (%g)\n", x, Value_0) ; 
  /* Handling consumers are equally distributed !!! */
}
