						                                          ...
						                                          double Value)
{
  ...
  if( Table->No_of_CELLS > 1 ) { 
    ...
    Table->Vector_Model_Variables_Time_0[0] = 0.0;   /* Initial value for propagules         */
    Table->Vector_Model_Variables_Time_0[1] = 0.0;   /* Initial value for resources */
    Table->Vector_Model_Variables_Time_0[2] = Value; /* Initial value for free consumers */
    Table->Vector_Model_Variables_Time_0[3] = 0.0;   /* Initial value for handling consumers */
  }
}
							                                               ...
							                                               double Value_1)
{
  ...
  Table->Vector_Model_Variables_Time_0[0] = 0.0;     /* Initial value for propagules         */
  Table->Vector_Model_Variables_Time_0[1] = Value_0; /* Initial value for resources          */
  Table->Vector_Model_Variables_Time_0[2] = Value_1; /* Initial value for free consumers     */
  Table->Vector_Model_Variables_Time_0[3] = 0.0;     /* Initial value for handling consumers */
