...
double neglogStarionary_Ditribution_Beddington_DeAngelis_Marginal_0(int ,Parameter_Table * );
...
double GSL_Function_to_Minimize_Beddington_DeAngelis_Marginal_0( const gsl_vector * x, void * Par )
{
  ...
  */
  ...
  if( x_is_BOUNDED == 1 ) { 
	...
	Theory[j] = neglogStarionary_Ditribution_Beddington_DeAngelis_Marginal_0 (n, Table);
      }
    }
...
double neglogStarionary_Ditribution_Beddington_DeAngelis_Marginal_0(int n,
								    Parameter_Table * Table)
{
  ...
  Theory = -log( Table->MEq->PS_n_Marginal[n] );
