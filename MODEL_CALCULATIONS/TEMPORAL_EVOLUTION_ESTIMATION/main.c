...
/* This code estimates ODE model parameters from data. Observed data are
   ...
   . ~$ ./DIFFUSION_1R1C_2D -y0 4 -y2 1 -HS 1 -HM 1 -HX 1 -HY 1 -n 2 -v0 0 -v1 1 -G0 1 -G1 2 -sT 1.0E-04 -sN 300 -sP 2 -I0 16 -m0 0.0 -M0 50.0 -A0 0.01 -I1 17 -m1 0.0 -M1 10.0 -A1 0.01 -iP 0 -en 0 -eV 100.0 -DP 0 -DC 0 -D0 0 -D1 1 -D2 0 -a0 0 -Fn 1 -F0 Pseudo_Empirical_Data.dat -Y0 99 -tn 99 -t0 0.0 -t1 80.0 -t4 0 -tR 10 -xn 0 -xN 50.0 -HN 50.0 -G2 1 -G3 0.0 -G4 80.0 -G5 1 -G6 0.0 -G7 2000 -H1 0.0 -HK 2000 -H4 1.0  
   ...
   According to the parameter correspondence (Entropy paper), this would correspond to the following effective true parameters in the 2D system: 
