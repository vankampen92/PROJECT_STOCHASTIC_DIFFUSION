...
void Initial_Condition_Master_Equation( Parameter_Table * Table, double * y_INI )
{
  ...
  /* No of Consumers at time 0 handling resource 1 */         /* n */ 
  n_Time_0 = Table->TOTAL_No_of_FREE_CONSUMERS_TIME_0;
  /* No of Consumers at time 0 handling resource 2 */         /* m */
  m_Time_0 = Table->TOTAL_No_of_FREE_CONSUMERS_TIME_0 - n_Time_0;
