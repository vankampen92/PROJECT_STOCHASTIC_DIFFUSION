					 ...
					 Parameter_Model * P)
{
  ...
  for(i=0; i<no; i++){
    ...
    AD[0][0] = 0;  AD[0][1] = 2; AD[0][2] = 4; AD[0][3] = 9;                               AD[0][m] = 4;
    AD[1][0] = 0;  AD[1][1] = 2; AD[1][2] = 4; AD[1][3] = 9;                               AD[1][m] = 4;
    AD[2][0] = 0;  AD[2][1] = 2; AD[2][2] = 4; AD[2][3] = 9;                               AD[2][m] = 4;

    AD[3][0] = 0;  AD[3][1] = 2; AD[3][2] = 4; AD[3][3] = 9;                               AD[3][m] = 4;
    ...
    AD[9][0] = 0;  AD[9][1] = 2; AD[9][2] = 4; AD[9][3] = 9; AD[9][4] = 10; AD[9][5] = 11; AD[9][m] = 6;
