#define MODEL_PARAMETER_SPACE_MAXIMUM 16 /* Maximum Dimension for Parameter Space */
...
#define OUTPUT_VARIABLES_MAXIMUM 160013     /* MODEL_STATE_VARIABLES_MAXIMUM + OUTPUT_VARIABLES_GENUINE_MAXIMUM */
