...
#define No_of_SPECIES_MAXIMUM 1

#define MODEL_STATE_VARIABLES_MAXIMUM 10000 /* Model dimension maximum: 1 * 10000 cells */
...
#define OUTPUT_VARIABLES_MAXIMUM 10003  /* MODEL_STATE_VARIABLES_MAXIMUM +
